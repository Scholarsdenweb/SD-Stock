# Generated by Django 5.2 on 2025-09-20 05:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('satatus', models.CharField(choices=[('draft', 'Draft'), ('approved', 'Approved'), ('received', 'Received'), ('cancelled', 'Cancelled')], default='draft', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recieved_data', models.DateField(default=datetime.datetime.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('kit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stock.kits')),
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stock.variant')),
            ],
        ),
        migrations.AddField(
