    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('good', 'Good'), ('damaged', 'Damaged'), ('lost', 'Lost')], max_length=50)),
                ('return_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stock.returns')),
            ],
        ),
        migrations.AddField(
            model_name='issue',
        ...
        migrations.AddField(
            model_name='returns',
            name='variants',
            field=models.ManyToManyField(related_name='returned_variants', through='stock.ReturnItem', to='stock.variant'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='variants',
            field=models.ManyToManyField(related_name='allocations', through='stock.AllocationItem', to='stock.variant'),
        ),
        migrations.AddField(
